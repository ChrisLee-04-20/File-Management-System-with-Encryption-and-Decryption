<template>
    <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
        <v-container class="mt-10 w-100">
            <h1 class="text-center mb-10">Encrypt and upload file with passphrase</h1>
            <v-row class="d-flex flex-column align-center">
                <v-col cols="12" md="5">
                    <v-text-field v-model="passphrase" :counter="10" label="Passphrase for encryption and decryption"
                        hide-details type="text" variant="solo" required></v-text-field>
                </v-col>
                <v-col cols="12" md="5">
...
const passphraseFileUploadApi = '/api/upload/encrypt_passphrase_v2'
